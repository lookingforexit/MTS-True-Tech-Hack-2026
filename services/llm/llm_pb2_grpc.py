...
import llm_pb2 as api_dot_llm_dot_v1_dot_llm__pb2
...
class LLMServiceStub(object):
    """LLMService provides a stateful LangGraph pipeline for Lua code generation.
    """
...
class LLMServiceServicer(object):
    ...
    def StartOrContinue(self, request, context):
        """StartOrContinue starts a new pipeline or continues an existing session.
        """
    ...
    def AnswerClarification(self, request, context):
        """AnswerClarification answers the clarification question for a session.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
