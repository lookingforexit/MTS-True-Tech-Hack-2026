    ...
    st.session_state.messages = [
        {
            ...
            "content": (
                ...
                "Контекст в формате JSON улучшает качество генерации, позволяя системе учитывать "
                "реальные данные и их структуру. Без контекста система также работает - просто "
                "опишите задачу текстом.\n\n"
                "Переменные (`wf.vars`) указывайте в боковой панели слева."
            ),
        }
    ]
